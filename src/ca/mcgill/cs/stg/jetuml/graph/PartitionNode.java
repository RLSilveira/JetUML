...
/**
 *   A partition node in a Activity diagram.
 */
public class PartitionNode extends RectangularNode implements ParentNode, ChildNode
{
	private static final int DEFAULT_TOP_WIDTH = 150;
	...
	/**
     * Construct a partition node with a default size.
	 */
	...
	@Override
	public PartitionNode clone()
	{
		PartitionNode cloned = (PartitionNode)super.clone();
	...
	{
		assert pNode instanceof PartitionNode || pNode == null;
		aContainer = pNode;
	}
	...
	{
		return aContainedNodes; // TODO there should be a remove operation on PartitionNode
	}
	...
	{
		pEncoder.setPersistenceDelegate(PartitionNode.class, new DefaultPersistenceDelegate()
		{
